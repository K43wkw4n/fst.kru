...
{ 
    public interface IBranchService
    {
        ...
        Task<Object> GetCountAdminByIdAsync(int branchId);
        ...
        Task<Object> GetNewsAdminByIdAync(int branchId); 
        ...
        Task<Object> GetCurriculumByIdAdminAsync(int branchId); 
        ...
        Task<Object> GetGerneralAsync();

        //-------------------------------------section-------------------------------------//

        Task<Object> GetSectionAdminAsync();
        Task<Object> GetSectionAsync();
        Task<Object> CreateUpdateSectionAsync(SectionDto request);
        Task<Object> RemoveSectionAsync(int sectionId); 
        Task<Object> RemoveSubsectionAsync(int subsectionId);
        Task<Object> UploadFileSectionAsync(IFormFile file);
        Task<Object> IsUsedSectionAsync(int sectionId);
    }
}
