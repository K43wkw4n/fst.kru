...
export const Branchs = {
  getCountAdminById: (id: number) =>
    requests.get(`Branch/GetCountAdminById?branchId=${id}`),
  ...
  createUpdateBranch: (values: any) => {
    ...
    return requests.post("Branch/CreateUpdateBranch", createFormData(values));
  },
  ...
  getNewsAdminById: (id: number) =>
    requests.get(`Branch/getNewsAdminById?branchId=${id}`),
  ...
  getCurriculumByIdAdmin: (id: number) =>
    requests.get(`Branch/GetCurriculumByIdAdmin?branchId=${id}`),
  ...
  getSectionAdmin: () => requests.get("Branch/GetSectionAdmin"),
  getSection: () => requests.get("Branch/GetSection"),
  createUpdateSection: (values: any) =>
    requests.post("Branch/CreateUpdateSection", values),
  removeSection: (id: number) =>
    requests.delete(`Branch/RemoveSection?sectionId=${id}`),
  removeSubsection: (id: number) =>
    requests.delete(`Branch/RemoveSubsection?subsectionId=${id}`),
  uploadFileSection: (values: any) =>
    requests.post("Branch/UploadFileSection", createFormData(values)),
  isUsedSection: (id: number) =>
    requests.onlyPost(`Branch/IsUsedSection?sectionId=${id}`),
};
