...
namespace api.Migrations
{
    ...
    [Migration("20240111090248_createInitDb35")]
    partial class createInitDb35
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 11, 16, 2, 48, 173, DateTimeKind.Local).AddTicks(7785)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 11, 16, 2, 48, 173, DateTimeKind.Local).AddTicks(7798)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$uAB9Te8t/BapaykSMtVBE.7pTkxqbN/WbFXdTHDIaDIPlVeCAXZjm",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
            ...
            modelBuilder.Entity("api.Models.fst.GeneralTopics", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.fst.SubGeneralTopics", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("GeneralTopicsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.fst.SubGeneralTopics", b =>
                {
                    b.HasOne("api.Models.fst.GeneralTopics", "GeneralTopics")
                        .WithMany("SubGeneralTopics")
                        .HasForeignKey("GeneralTopicsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
