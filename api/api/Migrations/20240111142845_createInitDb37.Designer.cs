...
namespace api.Migrations
{
    ...
    [Migration("20240111142845_createInitDb37")]
    partial class createInitDb37
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 11, 21, 28, 45, 389, DateTimeKind.Local).AddTicks(3367)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 11, 21, 28, 45, 389, DateTimeKind.Local).AddTicks(3379)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$skViXN63cNM5agGoKOX03OlZqpVG5xtF0Bb/.EkEtn429eQqPGjvq",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
