...
namespace api.Migrations
{
    ...
    [Migration("20240105025442_createInitDb13")]
    partial class createInitDb13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 5, 9, 54, 42, 363, DateTimeKind.Local).AddTicks(5396)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 5, 9, 54, 42, 363, DateTimeKind.Local).AddTicks(5412)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$mopyEmXSxWv8.o2efRP2E.LuPx051gUJf3TCwkal0gjGo6gTVAKHC",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
