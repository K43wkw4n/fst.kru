...
namespace api.Migrations
{
    ...
    [Migration("20231130065006_createInitDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$PtmVR0oznUbVfKadx97KEOxi4a8Km/Cd7OS00z0B0SNznOXWhWwS6",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
            ...
            modelBuilder.Entity("api.Models.Supplies.OrderSlipItem", b =>
                {
                    ...
                    b.Property<int>("LatestCodeWithdrawn")
                        .HasColumnType("int");

                    b.Property<int>("OrderSlipsID")
                        .HasColumnType("int");

                    b.Property<int>("Quantity")
                        .HasColumnType("int");

                    b.Property<int>("QuantityAlreadyWithdrawn")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.Supplies.PaymentVoucherItem", b =>
                {
                    ...
                    b.Property<int>("PaymentVouchersID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.Supplies.Supplies", b =>
                {
                    ...
                    b.Property<string>("SuppliesCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Year = new DateTime(2023, 11, 30, 13, 50, 6, 535, DateTimeKind.Local).AddTicks(4514)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Year = new DateTime(2023, 11, 30, 13, 50, 6, 535, DateTimeKind.Local).AddTicks(4579)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Supplies.PaymentVoucher", b =>
                {
                    b.HasOne("api.Models.Person.Personnel", null)
            ...
            modelBuilder.Entity("api.Models.Supplies.PaymentVoucherItem", b =>
                {
                    b.HasOne("api.Models.Supplies.OrderSlipItem", "OrderSlipItems")
                    ...
                    b.HasOne("api.Models.Supplies.PaymentVoucher", "PaymentVouchers")
                        .WithMany("PaymentVoucherItems")
                        .HasForeignKey("PaymentVouchersID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
