...
namespace api.Migrations
{
    ...
    [Migration("20240105174745_createInitDb18")]
    partial class createInitDb18
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 6, 0, 47, 45, 42, DateTimeKind.Local).AddTicks(5461)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 6, 0, 47, 45, 42, DateTimeKind.Local).AddTicks(5479)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$gO5vCsjwVU8DS45JIlmAeek4gEXNnKrvX8VJ51FjAbL1N6t6eaUYq",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
