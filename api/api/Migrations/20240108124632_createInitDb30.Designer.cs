...
namespace api.Migrations
{
    ...
    [Migration("20240108124632_createInitDb30")]
    partial class createInitDb30
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 8, 19, 46, 32, 177, DateTimeKind.Local).AddTicks(7395)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 8, 19, 46, 32, 177, DateTimeKind.Local).AddTicks(7411)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$veTsrrcLkjRCxe6vbsKr0ONQxhPKW5s6/FiUqNem0GkXwZrWsIL5W",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
