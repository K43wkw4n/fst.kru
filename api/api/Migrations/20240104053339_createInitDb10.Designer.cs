...
namespace api.Migrations
{
    ...
    [Migration("20240104053339_createInitDb10")]
    partial class createInitDb10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 4, 12, 33, 38, 782, DateTimeKind.Local).AddTicks(6226)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 4, 12, 33, 38, 782, DateTimeKind.Local).AddTicks(6236)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$chpawHun6hLm9S9taFMyAORymMcaGDEeuz3Ez7cheKmmQDNiy/KmS",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
