...
namespace api.Migrations
{
    ...
    [Migration("20240105162448_createInitDb17")]
    partial class createInitDb17
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 5, 23, 24, 48, 248, DateTimeKind.Local).AddTicks(9119)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 5, 23, 24, 48, 248, DateTimeKind.Local).AddTicks(9132)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$Ao287PIu/0ooYP2C15ctQe6kIrRtPyCi9c7oqqZaFWDRpupZ/EABy",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
