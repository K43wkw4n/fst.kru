...
namespace api.Migrations
{
    ...
    [Migration("20240105082730_createInitDb14")]
    partial class createInitDb14
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 5, 15, 27, 29, 772, DateTimeKind.Local).AddTicks(7478)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 5, 15, 27, 29, 772, DateTimeKind.Local).AddTicks(7488)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$aLzYLIyVR6lQa0xE1.I9sOKIFll6dJfHZHJ7Ux5MMEVu4og/5xk1u",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
