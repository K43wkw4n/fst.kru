...
namespace api.Migrations
{
    ...
    [Migration("20240110081458_createInitDb33")]
    partial class createInitDb33
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 10, 15, 14, 58, 479, DateTimeKind.Local).AddTicks(3998)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 10, 15, 14, 58, 479, DateTimeKind.Local).AddTicks(4011)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$H/L4M8qPwSO9y9KcF8uyhe95p9pCNCWlDkTxXvXohfCdhITAUa8JC",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
