...
namespace api.Migrations
{
    ...
    [Migration("20240107163754_createInitDbWeLearn")]
    partial class createInitDbWeLearn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 7, 23, 37, 54, 289, DateTimeKind.Local).AddTicks(3847)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 7, 23, 37, 54, 289, DateTimeKind.Local).AddTicks(3856)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$VoaQhaLXmH9eXRZ7LoTyouZRHzmeAVyfU4hQQX63l3kKU6NX3E4UW",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
