...
namespace api.Migrations
{
    ...
    [Migration("20240104154518_createInitDb11")]
    partial class createInitDb11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 4, 22, 45, 18, 303, DateTimeKind.Local).AddTicks(460)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 4, 22, 45, 18, 303, DateTimeKind.Local).AddTicks(471)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$AVWwQcNEg.VH9fKPAdLHl.JFOwz09V3n3aQyPNAKMgAysTb4Qao6e",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
