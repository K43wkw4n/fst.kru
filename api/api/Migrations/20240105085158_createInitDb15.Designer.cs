...
namespace api.Migrations
{
    ...
    [Migration("20240105085158_createInitDb15")]
    partial class createInitDb15
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 5, 15, 51, 57, 962, DateTimeKind.Local).AddTicks(6551)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 5, 15, 51, 57, 962, DateTimeKind.Local).AddTicks(6569)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$kywZw.5T1UIL0bzZ.u9VZeD7trYYjtT.vQ4PObUX2z7JhyfUc78ce",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
