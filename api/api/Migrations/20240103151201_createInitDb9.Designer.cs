...
namespace api.Migrations
{
    ...
    [Migration("20240103151201_createInitDb9")]
    partial class createInitDb9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 3, 22, 12, 1, 202, DateTimeKind.Local).AddTicks(5503)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 3, 22, 12, 1, 202, DateTimeKind.Local).AddTicks(5512)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$YMFflBxYzaVqPyYKREqIp.Tqvp8RCg8d20kKuJjonDTDvXupWWCFi",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
