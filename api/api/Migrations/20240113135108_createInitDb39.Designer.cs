...
namespace api.Migrations
{
    ...
    [Migration("20240113135108_createInitDb39")]
    partial class createInitDb39
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Parcel.Parcel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2990.0,
                            Year = new DateTime(2024, 1, 13, 20, 51, 7, 858, DateTimeKind.Local).AddTicks(1839)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Price = 25.0,
                            Year = new DateTime(2024, 1, 13, 20, 51, 7, 858, DateTimeKind.Local).AddTicks(1865)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Person.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LvEdu = "ป.ตรี",
                            PasswordHash = "$2a$11$7uU77Eu61yC33g35OVLLmeYcU7QzkWHhDEMDv7uDVYGluB8/td1ly",
                            PrefixID = 1,
                            RoleID = 1,
                            UserName = "Hachi"
                        });
